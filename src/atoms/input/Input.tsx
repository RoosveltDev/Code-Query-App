    ...
    return (
      <div className='input-wrapper'>
        <div className='form-container__input-container input-container'>
          <input
            onBlur={(e) => labelAnimation(e, index, inputElement.type)}
            id={`${inputElement.type}${inputElement.label}`}
          ...
          <label
            ...
            htmlFor={`${inputElement.type}${inputElement.label}`}
          >
            {inputElement.label.charAt(0).toUpperCase() +
              inputElement.label.slice(1)}
          </label>
          {inputElement.type === "password" ? (
            <>
              <svg
                onClick={(e) => passwordEyeClicked(e)}
                className='input_containar__password--active'
              ...
              <svg
                onClick={(e) => passwordEyeClicked(e)}
                className='input_containar__password--disable'
                xmlns='http://www.w3.org/2000/svg'
                viewBox='0 0 640 512'
              >
