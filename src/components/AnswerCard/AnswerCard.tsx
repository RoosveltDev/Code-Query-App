...
export default function AnswerCard({
  ...
  onComment,
  className = "",
}: Answer & { className?: string; onComment?: () => void ,questionId?:string,ownerId?:number}) {
    ...
    <div className={`answer-card ${className}`}>
      ...
      <div className='answer-content'>
        ...
        {questionId && <div className='answer-actions'>
          ...
          {userLogged.id === Number(ownerId) &&  <div className="answer-actions__live live-container-answer">
