...
const PopUp = ({inputs, submit,setIsCreatedChat}: PopUpType) => {
    ...
    <div className="popUp-overlay-main">
        <div className="popUp-overlay-main__popup popUp-container">
            <div className="popUp-container__actions actions-popUp">
                <h1 className="actions-popUp__header">Create chat</h1>
            ...
            <Form submit={submit} inputs={inputs} buttonText="Create chat" >
                <></>
            </Form>
